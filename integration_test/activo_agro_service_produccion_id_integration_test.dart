...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final activoId =
    'activo-test-produccion-ciclo-${DateTime.now().millisecondsSinceEpoch}';
      ...
      expect(
        activoRecuperado!.producciones,
        isNotEmpty,
      );

      final moduloCreado =
          activoRecuperado.producciones.first;
