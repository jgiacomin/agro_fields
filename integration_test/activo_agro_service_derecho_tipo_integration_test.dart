...
void main() {
  ...
  testWidgets(
    'GAP-RWA-02 02.03 - persiste y recupera tipo de derecho',
    (tester) async {
      ...
      final activoId =
          'activo-rwa02-0203-$sufijo';

      final derechoId =
          'derecho-rwa02-0203-$sufijo';
      ...
      final activo = ActivoAgroV2(
        activoId: activoId,
        nombre: 'Activo de prueba para Tipo de Derecho',
        descripcion:
            'Activo técnico para validar GAP-RWA-02 02.03.',
        ...
        participantes: [],
        propietarioId: 'usuario-rwa02-0203-$sufijo',
        creadorId: 'usuario-rwa02-0203-$sufijo',
        publicadorId: 'usuario-rwa02-0203-$sufijo',
      ...
      // 5. Verificar reconstrucción de DerechoActivo.
