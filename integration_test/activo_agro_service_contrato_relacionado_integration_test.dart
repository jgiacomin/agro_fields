...
void main() {
  ...
  testWidgets(
    'GAP-RWA-02 02.13 - contrato relacionado a DerechoActivo con evidencia, historial y auditoria',
    (tester) async {
      ...
      final activo = ActivoAgroV2(
        activoId: activoId,
        nombre:
            'Activo de prueba para Contrato Relacionado',
        descripcion:
            'Activo tecnico para validar GAP-RWA-02 02.13.',
      ...
      // =====================================================
      // 2. REPRESENTAR DERECHO CON CONTRATO RELACIONADO
      // =====================================================
      ...
      final derecho = DerechoActivo(
        ...
        descripcionObjeto:
            'Derecho de uso instrumentado mediante contrato.',
        ...
        fechaInicio: fecha,
        fechaFin:
            DateTime(2031, 9, 23, 10, 0),
        estado: 'vigente',
        condiciones: [
          'Contrato relacionado con el derecho.',
          'Vigencia contractual durante la vigencia del derecho.',
        ],
        fechaCreacion: fecha,
        ultimaActualizacion: fecha,
      );
      ...
      // =====================================================
      // 3. CREAR EVIDENCIA DEL CONTRATO
      // =====================================================
      ...
      final evidencia = Evidencia(
        ...
        descripcion:
            'Evidencia documental del contrato relacionado con el DerechoActivo.',
        observaciones:
            'Contrato utilizado para validar GAP-RWA-02 02.13.',
      ...
      // =====================================================
      // 4. REGISTRAR DERECHO + CONTRATO + EVIDENCIA
      // =====================================================
      ...
      // =====================================================
      // 6. VERIFICAR EVIDENCIA VINCULADA AL CONTRATO
      // =====================================================
      ...
      expect(
        evidenciaData['fuenteReferencia'],
        'TEST-RWA02-0213-FUENTE-$sufijo',
      );

      expect(
        evidenciaData['soporteReferencia'],
        'TEST-RWA02-0213-SOPORTE-$sufijo',
      );
      ...
      expect(
        activoRecuperado.derechos.first.tipoInstrumento,
        'contrato',
      );
      ...
      final eventoContrato =
          activoRecuperado.historial.firstWhere(
        (evento) =>
            evento.tipoEvento ==
                'registro_derecho_activo' &&
            evento.referenciaId ==
      ...
      final datosEvento =
    eventoContrato.datosEvento ??
        const <String, dynamic>{};

       expect(
        datosEvento['tipoInstrumento'],
         'contrato',
    );

      expect(
       datosEvento['identificadorInstrumento'],
       'TEST-RWA02-0213-CONTRATO-$sufijo',
    );
     ...
     expect(
      ...
      final datosAuditoria =
        ...
        auditoriaContrato['datos'] ?? const {},
      );

      expect(
        datosAuditoria['tipoInstrumento'],
        'contrato',
      );

      expect(
        datosAuditoria['identificadorInstrumento'],
        'TEST-RWA02-0213-CONTRATO-$sufijo',
      );
