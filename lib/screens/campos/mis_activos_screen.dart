...
class MisActivosScreen extends StatefulWidget {
  ...
  @override
  State<MisActivosScreen> createState() =>
      _MisActivosScreenState();
...
class _MisActivosScreenState
    extends State<MisActivosScreen> {


  final ActivoAgroServiceV2 servicio =
      ActivoAgroServiceV2();
  ...
  Future<void> cargarActivos() async {
    ...
    try{
      ...
      await servicio.buscarPorPropietario(
        usuario.uid,
      );
